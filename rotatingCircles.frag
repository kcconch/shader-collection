...
void main(){
    ...
    float blink = sqrt((abs(sin(u_time))))/50.0 + 0.01;
    ...
    vec2 translate2 = vec2(cos(u_time-100.0),sin(u_time-100.0));
    vec2 translate3 = vec2(cos(u_time-200.0),sin(u_time-200.0));
    vec2 translate4 = vec2(cos(u_time-400.0),sin(u_time-400.0));
